...
private void addRecipe() {
	...
	Integer nunServerings = getIntInput("Enter number of servings");
	...
	recipe.setNumServings(nunServerings);
...
private int getOperation() {
	printOperations();
	Integer op = getIntInput(" \nEnter an opertaion number(press Enter to quit ");
...
private Integer getIntInput(String prompt) {
	...
	try {
		...
		throw new DbException( input + " is not a valid nummber");
	}
}
